...
const SKILLS_SECTIONS = [
    { icon: <Code className="w-6 h-6" />, title: "Programming Languages", tags: ["C++", "C#", "JavaScript", "SQL", "HTML", "CSS"] },
    { icon: <Layers className="w-6 h-6" />, title: "Frameworks & Libraries", tags: ["React.js", "Bootstrap", "ASP.NET Core", "MVC", "Web API", "Web Forms"] },
    { icon: <Terminal className="w-6 h-6" />, title: "Tools & Platforms", tags: ["Git", "GitHub", "VS Code", "VS 2022"] },
