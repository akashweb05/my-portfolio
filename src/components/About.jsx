...
import myPhotograph from "../assets/myPhotograph.png";
...
const SOCIAL_LINKS = [
  {
    href: "https://github.com/akashweb05",
    icon: <Github className="w-5 h-5" />,
    title: "GitHub",
  },
  {
    href: "https://www.linkedin.com/in/akashweb05/",
    icon: <Linkedin className="w-5 h-5" />,
    title: "LinkedIn",
  },
  {
    href: "mailto:akashweb05@gmail.com",
